...
{
    public partial class IsoscelesForm : Form
    {
        public IsoscelesForm()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (double.Parse(textBox1.Text) * 2 > double.Parse(textBox2.Text) && double.Parse(textBox2.Text) != 0)
                {
                    label4.Text = $"Com o lado de tamanho: {double.Parse(textBox1.Text)}\nE a base de tamanho: {double.Parse(textBox2.Text)}";
                    Isosceles is1 = new Isosceles(double.Parse(textBox1.Text), double.Parse(textBox2.Text));
                    label2.Text += is1.CalcularPerimetro();
                    label3.Text += is1.CalcularArea();
                    textBox1.Text = "";
                    textBox2.Text = "";
                }
                else
                {
                    label4.Text = "É impossível construir um triângulo isósceles\ncom essas medidas!";
                    textBox1.Text = "";
                    textBox2.Text = "";
                }
            }
