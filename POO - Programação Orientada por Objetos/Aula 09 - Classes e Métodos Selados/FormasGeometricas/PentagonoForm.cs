...
namespace FormasGeometricas
{
    public partial class PentagonoForm : Form
    {
        ...
        {
            label2.Text = "O valor do perimetro desse pentágono é de: ";
            label3.Text = "O valor da área desse pentágono é de: ";
            if (textBox1.Text != "")
            {
                label4.Text = $"Com o lado de tamanho: {double.Parse(textBox1.Text)}";
                Pentagono p1 = new Pentagono(double.Parse(textBox1.Text));
